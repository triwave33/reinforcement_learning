...
class NNAgent:
    ...
    def train(self,s,a,reward,s_dash,a_dash):
        ...
        target = r_batch + GAMMA * Q_val_dash * (self.done -1.) * -1. # means r when done else r + GAMMA * Q'
        targets[0,_a] = target
...
agent_NN = DqnAgent(lr=1.E-4, h1=320, h2=160, TAU=5, num_memory = 10000, in_dim=NUM_STATE, out_dim=NUM_ACTION, eps_ini=0, eps_last=0)

agent = agent_NN # 使用するエージェントを選択
